require([
  ...
  function createClientSideLayer() {
    ...
    const rendererClone =
      serviceLayer.renderer && serviceLayer.renderer.clone
  ...
  function setupUIEvents() {
    toggleAddBtn.addEventListener("click", () => {
      ...
      if (addMode) {
        ...
        addModeInfo.textContent =
          "Add mode ON: click on the map to add a point.";
      } else {
      ...
      clientLayer
        ...
        .then((editResult) => {
          ...
          if (
            ...
            console.log(
              "Feature added locally with OBJECTID:",
              assignedObjectId
            );
          } else {
            console.warn(
              "No objectId returned from applyEdits; storing with local counter."
            );
            const record = {
              OBJECTID: featureIdCounter,
              status: selectedStatus,
